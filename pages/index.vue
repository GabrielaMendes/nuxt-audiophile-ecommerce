		...
		<template #content>
			...
			<section class="flex flex-col gap-7">
				...
				>
					...
					<div class="max-w-[24rem] max-lg:text-center max-lg:mx-auto lg:mt-6 z-10">
						<h1 class="mb-8 sm:mb-6 max-lg:px-6 max-sm:text-4xl">ZX9 Speaker</h1>
						<p class="white opacity-75 mb-8 sm:mb-10 z-10">
							Upgrade to premium speakers that are phenomenally built to deliver
							truly remarkable sound. See product
						</p>
						<BaseButton :black="true" class="" />
					</div>
				</div>
